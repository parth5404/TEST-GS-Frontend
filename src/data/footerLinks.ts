const footerLinks = [
...

  {
    ...
    links: [
      { title: "Electronics and Communication", link: "/ece" },
      { title: "Computer Science", link: "/cse" },
      { title: "Information Technology", link: "/it" },
      { title: "Mechanical Engineering", link: "/mechanical" },
      ...
      { title: "Control Systems", link: "/control-systems" },
      { title: "Signal Processing", link: "/signal-processing" },
    ],
  },
  {
    ...
    links: [
      ...
      { title: "MATLAB", link: "/matlab" },
      { title: "JavaScript", link: "/javascript" },
    
      { title: "SQL", link: "/sql" },
      { title: "Assembly", link: "/assembly" },
      { title: "Verilog", link: "/verilog" },
      { title: "VHDL", link: "/vhdl" },
      { title: "LabVIEW", link: "/labview" },
