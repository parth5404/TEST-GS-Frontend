...
const Navbar = () => {
  ...
  return (
    <div className='bg-white border-b border-b-richblack-700 h-14 text-black' >
      <div className='w-11/12 h-14 mx-auto max-w-maxContent flex flex-row items-center justify-between' >
                  ...
                  <li key={ind} >
                    {
                      link.title === 'Catalog'
                        ...
                        (
                          <Link to={link?.path} >
                            <p className={`${matchRoute(link?.path) ? 'text-blue-900 font-semibold' : 'text-black font-semibold'}`} >{link.title}</p>
                          </Link>
                        )
                    }
                  </li>
        ...
        <div className='hidden md:flex gap-x-4 items-center' >
          ...
          }
          {
            ...
            (
              <Link to={'/login'} >
                <button className='border border-richblack-700 bg-richblack-800 text-white font-bold rounded-md px-3 py-2' >Log in</button>
              </Link>
            )
          }

          {
            ...
            (
              <Link to={'/signup'} >
                <button className='border border-richblack-700 bg-richblack-800 text-white font-bold rounded-md px-3 py-2' >Sign Up</button>
              </Link>
            )
          }
