  ...
  return (
    <div className='flex flex-col mt-5 md:mt-10 mb-8 lg:mb-20 items-center' >
      <div>
        ...
        <div className='mt-3 lg:w-[75%]  mx-auto text-center text-white text-base font-medium' >Using spin making learning multiple languages easy. with 20+ languages realistic voice-over, progress tracking, custom schedule and more.</div>
      </div>
