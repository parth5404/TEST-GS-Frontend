    ...
    <div className='text-black' >
      ...
      <div className='bg-white' >
        <div className='relative w-11/12 mx-auto max-w-maxContent flex flex-col justify-between py-20' >
          <h1 className='text-center font-semibold text-4xl mx-auto lg:w-[90%]' >Driving Innovation in Online Education for a
          ...
          <div className=' absolute  translate-y-[75%] left-[50%] translate-x-[-50%] w-full grid grid-cols-3 gap-3 lg:gap-8' >
      ...
      {/* Section 2
      <div className='bg-rich-black-400 border-b border-richblack-700' >
        <div className='mt-[0px] w-11/12 mx-auto max-w-maxContent flex flex-col justify-between' >
          <Quote />
        </div>
      </div> */}
