          ...
          >
            {
              index > 0
                ...
                <div className='flex flex-col gap-3 pb-10 lg:pb-0 lg:w-[90%]' >
                  ...
                  <p className='text-richblack-300 font-medium' >GS Academia partners with more than 275+ leading universities and companies to bring flexible, affordable, job-relevant online learning to individuals and organizations worldwide.</p>
